...
void option1(){
    ...
    sleep(3);
    printf("At the beginning, Jürgen Klopp(The manager) said to %s:\"This is gonna be a hard\"\n", name1);
    ...
    sleep(3);
    printf("Jürgen Klopp: \"Now you guys are the chosen\"\n");
    sleep(1);
    printf("Jürgen Klopp: \"What position do you wanna play, %s?\"\n",name1);
    sleep(3);
    ...
    sleep(2);
        ...
        sleep(3);
        printf("\"%s finally get a chance to play on a professional field by switching with Sadio Mané at 75'\"\n",name1);
        sleep(3);
...
void option2(){
    ...
    sleep(2);
        ...
        sleep(3);
        printf("\"%s finally get a chance to play on a professional field by switching with Luis Suárez at 75'\"\n",name1);
        sleep(3);
        printf("***5 minutes after %s joined***\n",ans);
        sleep(3);
        printf("~~~GOOOAAALLLLLL~~~\n");
        ...
        printf("***After a few matches***\n");
        sleep(3.5);
        printf("\"Now Barcelona F.C is facing against Atlético Madrid with the score 0-0\"\n");
        sleep(3);
        ...
        sleep(3);
        printf("\"%s finally get a chance to play on a professional field by switching with Gerard Piqué at 75'\"\n",name1);
        sleep(3);
        printf("***5 minutes after %s joined***\n",ans);
        sleep(3);
        printf("~~~GOOOAAALLLLLL~~~\n");
...
void option3(){
    ...
    sleep(2);
        ...
        sleep(3);
        printf("\"%s finally get a chance to play on a professional field by switching with Higuaín at 75'\"\n",name1);
        sleep(3);
        printf("***5 minutes after %s joined***\n",ans);
        sleep(3);
        printf("~~~GOOOAAALLLLLL~~~\n");
